...
pub fn rewrite_schema(
    ...
    fn rewrite_schema_fields(
        ...
        for i in 0..src_fields.len() {
            ...
            trace!(target:"deepschema", "rewrite_schema_fields: parent={}, src_field_path={}, filters={:?}", parent, src_field_path, filters);
    ...
    fn rewrite_schema_field(
        ...
        trace!(target:"deepschema", "rewrite_schema_field: src_field_name={}, src_field_path={}, filters={:?}", src_field_name, src_field_path, filters);
