    ...
    plan.transform_down(|plan| {
        ...
        match plan {
            ...
            LogicalPlan::TableScan(table_scan) => {
                ...
                trace!(target: "deep", "TABLE SCAN: input cols_level= {:?}", &cols_level);
                ...
                trace!(target: "deep", "TABLE SCAN COLUMNS FOR ME({}): {:?}", table_name.table(), columns_for_this_scan);
                ...
                trace!(target: "deep", "TABLE SCAN COLUMNS FOR ME({}): {:?}", table_name.table(), single_columns_for_this_scan);
                ...
                trace!(target: "deep", "TABLE SCAN COLUMNS FOR ME({}): {:?}", table_name.table(), fixed_single_columns_for_this_scan);
...
pub fn fix_deep_projection_according_to_table_schema(
    ...
    for (col, deep_projection_specifiers) in input {
        // trace!(target: "deep", "fix_deep_projection_according_to_table_schema checking {:?}", col);
        let col_to_check = Column::new_unqualified(col.name.clone());
        if let Some(col_idx_in_schema) = schema.maybe_index_of_column(&col_to_check) {
...
//     trace!(target: "deep", "APPEND: {:?} = {:?}", column, rest);
//     match acc.get_mut(column) {
//         None => {
//             let column_clone = column.clone();
//             if rest.len() > 0 {
